    ...
    **kwargs : dict, optional
    ...
    class Drivetrain():
        ...
        def Transmission(self, cgx, cgy, massa, etex, cfat, rpneu, acpi, redp, red1, optimized_cp):
            peso, rnet, rned, ftr, tdcl, cnet, ptet, cpneu, tpneu, redf, tpwt, acpr, acfi, acfr, fti, tpi, tpwti, tci, tcr, cteti = Drivetrain.CalculateOutputs(cgx, cgy, massa, etex, cfat, rpneu, acpi, redp, red1, optimized_cp)
            rpm_values, torque_values, power_values = Drivetrain.CurveTorquePower(Drivetrain.matriz_dados)
        ...
        def objective_function(self, cp, cgx, cgy, massa, etex, cfat, rpneu, acpi, redp, red1):
            # Calcula os outputs
            outputs = Drivetrain.CalculateOutputs(cgx, cgy, massa, etex, cfat, rpneu, acpi, redp, red1, cp)
            ...
            performance = Drivetrain.CarPerformance(massa, rpneu, redp, red1, cp)
        ...
        def optimize_cp(self, cgx, cgy, massa, etex, cfat, rpneu, acpi, redp, red1):
            ...
            result = minimize(Drivetrain.objective_function, initial_guess, args=(cgx, cgy, massa, etex, cfat, rpneu, acpi, redp, red1), method='BFGS')
        ...
        def HalfShaftsSizing(self, redp, red1, optimized_cp, fsi=1.25, tet=786, tec=471.6, dif=1):
            ...
            tmax = max(data["trq"] for data in Drivetrain.matriz_dados)
        ...
        def main(self):
            ...
            optimized_cp, objective_value = Drivetrain.optimize_cp(cgx, cgy, massa, etex, cfat, rpneu, acpi, redp, red1)
